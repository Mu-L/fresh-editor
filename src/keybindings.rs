...
impl KeybindingResolver {
    ...
    fn format_action(action: &Action) -> String {
        match action {
            ...
            Action::OpenConfig => "Open configuration".to_string(),
            Action::OpenHelp => "Open help".to_string(),
            Action::OpenThemeSwitcher => "Open theme switcher".to_string(),
            Action::OpenLogs => "Open logs".to_string(),
            Action::Back => "Navigate back".to_string(),
            Action::Forward => "Navigate forward".to_string(),
            Action::Prompt => "Open prompt".to_string(),
            Action::PopupShowDocumentation => "Show documentation".to_string(),
            Action::PopupScrollDown => "Scroll popup down".to_string(),
            Action::PopupScrollUp => "Scroll popup up".to_string(),
            Action::Find => "Find".to_string(),
            Action::FindPrev => "Find previous".to_string(),
            Action::ReplaceNext => "Replace next".to_string(),
            Action::PromptSaveAs => "Save as...".to_string(),
            Action::PromptOpen => "Open...".to_string(),
            Action::PromptSearch => "Search...".to_string(),
            Action::PromptReplace => "Replace...".to_string(),
            Action::PromptCommand => "Command...".to_string(),
            Action::PromptClose => "Close prompt".to_string(),
            Action::Popup => "Show popup".to_string(),
        }
    }
